#https://github.com/RedstoneWill/MachineLearningInAction/blob/master/Perceptron%20Linear%20Algorithm/PLA.ipynb
#-*- coding: UTF-8 -*-
# PLA算法
...
data = pd.read_csv('../Assets/data/data1.csv', header=None)
