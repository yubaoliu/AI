% Program: charalambous_m.m
% Title: Modified Charalambous minimax algorithm.
% Description: Implements the modified Charalambous minimax 
% algorithm (Algorithm 8.4) for the design of stable lowpass,
...
%   bfgs_charalambous.m; eval_f.m; f_charalambous.m; 
%   g_charalambous.m; get_ksi_lambda.m; inex_lsearch.m; 
%   initialize.m, stabilize.m
% Input:
...
%   epsi1: termination tolerance for Algorithm 8.4
...
% Example:
% Applying Algorithm 8.4, design a 6th-order lowpass stable
...
%   epsi1 = 1e-9
%   epsi2 = 1e-9
% [a,b,as,bs,ep_max,ea_max,k]=charalambous_m(typ,f,N,K,l,epsi1,epsi2,x_ini)
% or
% [a,b,as,bs,ep_max,ea_max,k]=charalambous_m(typ,f,N,K,l,epsi1,epsi2)
% =========================================================================
function[a,b,as,bs,ep_max,ea_max,k]= ...
   charalambous_m(typ,f,N,K,l,epsi1,epsi2,x_ini)
disp(' ')
disp('Program charalambous_m.m')
warning off
L = l;
