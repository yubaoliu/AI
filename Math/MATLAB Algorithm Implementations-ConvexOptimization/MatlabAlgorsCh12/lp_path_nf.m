% Program: lp_path_nf.m
% Title: Nonfeasible-initialization primal-dual 
%     path-following algorithm for standard-form 
%     LP problems.
% Description: Implements Algorithm 12.5 for 
%    standard-form LP problems.
% Theory: See Practical Optimization Sec. 12.5.2.
% Input:  
...
% rou = 2
% espi = 1e-6
% [xs,fs,k] = lp_path_nf(A,b,c,x0,lmd0,mu0,rou,epsi)
% =====================================================
function [xs,fs,k] = lp_path_nf(A,b,c,x0,lmd0,mu0,rou,epsi)
disp('    ')
disp('Program lp_path_nf.m')
% Data initialization
n = length(x0);
rou_n = n + rou;
x = x0(:);
