/*
*dcocument: http://www.learnopencv.com/?s=homography
...
int main( int argc, char** argv)
{
	...
	if (argc < 2)
	{
		printf("Usage: ./Homography ../../data/images/first-image.jpg ../../data/images/times-square.jpg  \n or set the argument to '../../../data/images/times-square.jpg ../../../data/images/times-square.jpg' in VS");
		return -1;
	}

    // Read in the image.
   // Mat im_src = imread("../../../src/virtual-billboard/first-image.jpg");
    ...
    // Destination image
    //Mat im_dst = imread("../../../src/virtual-billboard/times-square.jpg");
